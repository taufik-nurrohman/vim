...
hi FoldColumn ctermfg=244 ctermbg=234 cterm=NONE guifg=#808080 guibg=#1c1c1c gui=NONE
hi Folded ctermfg=244 ctermbg=234 cterm=NONE guifg=#808080 guibg=#1c1c1c gui=NONE
...
hi DiffAdd ctermfg=233 ctermbg=10 cterm=NONE guifg=#121212 guibg=#2e8b57 gui=NONE
hi DiffChange ctermfg=244 ctermbg=236 cterm=NONE guifg=#808080 guibg=#303030 gui=NONE
hi DiffDelete ctermfg=244 ctermbg=203 cterm=NONE guifg=#121212 guibg=#ff5f5f gui=NONE
hi DiffText ctermfg=221 ctermbg=236 cterm=inverse guifg=#ffd75f guibg=#303030 gui=inverse
